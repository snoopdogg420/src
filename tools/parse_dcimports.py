...
parser.add_argument('--output', '-o', default='DCClassImports.py',
                    help='The name of the generated Python file.')
parser.add_argument('files', nargs='+', default=['otp.dc', 'toon.dc'],
                    help='The DClass files that will be used to generate the '
                         'Python file.')
...
data = '''\
# This file was generated by the parse_dcimports.py utility.
from pandac.PandaModules import *
