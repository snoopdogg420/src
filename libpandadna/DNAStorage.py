...
class DNAStorage:
    ...
    def getSuitPath(self, startPoint, endPoint, minPathLen = 40, maxPathLen = 300, allowStreetOnly = True):
        if not allowStreetOnly:
            raise ValueError("allowStreetOnly must be 1 in TTI")
            ...
            for edge in edges:
                ...
                if isStreetPoint:
                    ...
                    if allowStreetOnly:
                        ...
                        # NOT VALID IN TTI (allowStreetOnly should be 1)
