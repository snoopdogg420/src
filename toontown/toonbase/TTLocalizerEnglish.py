...
MusicTtrTheme = 'The Toontown Infinite Theme'
...
CogThiefGameInstructions = 'Stop these robots from stealing our gags! Press the Alt or Delete key to throw pies. Be careful- they have a tendancy to explode!'
