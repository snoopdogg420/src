...
class DistributedToonInteriorAI(DistributedObjectAI):
    ...
    def nextSnowmanHeadPart(self):
        ...
        if av.savedCheesyEffect == 14:
            #av.setSystemMessage(0, 'You have already completed the snowman head quest!')
        ...
        if self.zoneId in snowmanHeadInteriors:
            ...
            if str(avId) in self.air.snowmanProgress:
                ...
                if avProg == snowmanHeadInteriors[-1]:
                    #av.d_setSystemMessage(0, 'You have already completed the snowman head quest!')
                ...
                if avNextProg == snowmanHeadInteriors[-1]:
                    ...
                    av.d_setSystemMessage(0, 'Congratulations on finding all the buildings. Enjoy your snowman head!')
            else:
                # start of quest
